...
namespace AndradeShop.Core.Domain.EventSourcing
{
    public class EventStoredEvent : IAppEvent
    {
        private EventStoredEvent(Guid id, Guid? entityId, string jsonCommand, string commandTypeOf,
            EventType type, bool success, string fullException, string messageException)
        {
            Id = id;
